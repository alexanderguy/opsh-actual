...
ALL_SRCS = $(FOUNDATION_SRCS) $(PARSER_SRCS) $(MAIN_SRCS)
...
.PHONY: all clean test test-tap test-foundation test-parser format format-check
...
test: test-tap test-foundation test-parser
